...
const History = (props) => {
    ...
    return (<><h1 style={{fontFamily:"unset",fontSize:"250%"}}>המשימות שבוצעו:</h1>
        <h2>חיפוש משימה:</h2>
        <input style={{width:"15%"}} type="text" ref={inputRef} onKeyUp={updateinputRefShreach} />
